...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "d",     function ()
              awful.util.spawn("rofi -i -show drun -modi drun -show-icons") end,
...
-- awful.spawn.with_shell("/home/amehdipour/.config/polybar/launch.fish")
awful.spawn.with_shell("picom &")
awful.spawn.with_shell("xinput --set-prop 9 'libinput Accel Profile Enabled' 0, 1 &")
awful.spawn.with_shell("pw-metadata -n default set default.configured.audio.sink node_id &")
-- Set the refresh rate for the main monitor
awful.spawn.with_shell("xrandr --output DP-2 --rate 144 &")


-- Mouse cursor size
beautiful.cursor_size = 60
...
--
-- client.connect_signal("focus", function (c) c.border_color = "#f5e0dc" end)
